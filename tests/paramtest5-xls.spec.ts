...
const sheetNames=workbook.SheetNames[0]; // this will give us the name of the first sheet in the workbook 
const worksheet=workbook.Sheets[sheetNames]; // this will give us the actual sheet object that we can work with to extract data from it
